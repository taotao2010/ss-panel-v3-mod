										...
										<div class="card-inner">
											<div class="tab-content">
												...
												<div class="tab-pane fade" id="all_ios">
													<p>1.请确保你的系统版本是9.0或更高<br>2.有外区账号的可以购买并下载<a href="https://itunes.apple.com/us/app/shadowrocket/id932747118?mt=8">Shadowrocket</a>，没有的可以使用<a href="http://git.oschina.net/ssr233/ssr233/blob/master/ios_share_account.md">公共美区账号</a><br>3.在设备上的Safari浏览器上点击<a href="{$ssr_url_all}">这个链接</a>，提示用Shadowrocket打开，同意<br>4.点击顶部“未连接”旁边的开关，第一次会弹出权限提示，点Allow，需要指纹授权一次</p>
												</div>
